    ...
    <PolicyWrapper>
      ...
      <div style={{ animation: 'fadeIn 0.8s ease' }}>
        ...
        <Section>
          ...
          <List>
            <li><strong>Device and Browser Data:</strong> Information about your browser type and version, operating system, device type (desktop, mobile, smart device, etc.), unique device identifiers, screen size, and performance data.</li>
            <li><strong>Usage Data:</strong> Pages or screens visited, session durations, navigation paths, app usage, in-app interactions (e.g., gameplay, in-app purchases), install timestamps, and advertisement interactions.</li>
            <li><strong>Cookie and Tracking Data:</strong> We use cookies, web beacons, tags, scripts, and similar tracking technologies to gather technical details such as IP address, language settings, time zone, and clickstream data. This helps us provide a personalized experience, manage advertising, and improve our Services.</li>
            <li><strong>Advertising Identifiers:</strong> Unique advertising IDs (such as IDFA for iOS, AAID for Android, or other similar identifiers) that enable cross-app tracking for personalized advertising.</li>
            <li><strong>Communications:</strong> When you contact us (for support or legal inquiries), we collect the information you provide (e.g., your name, email address, and message content) to respond to your inquiry.</li>
          </List>
        </Section>

        <Section>
          <SectionTitle>4. Purpose of Use</SectionTitle>
          <Paragraph>The information we collect is used for multiple purposes, including to:</Paragraph>
          <List>
        ...
        <Section>
          ...
          <Paragraph>
            We use a variety of tracking technologies—including cookies, web beacons, tags, and scripts—to automatically collect technical data about your use of our Services. This helps us analyze usage patterns, personalize your experience, manage advertising, and improve overall Service performance. You may adjust your browser settings to decline cookies, but note that this may affect your ability to use certain parts of our Services.
          </Paragraph>
        </Section>
        ...
        <Section>
          ...
          <Paragraph>
            Our Services incorporate third-party tools for analytics, advertising, and data collection. These include, but are not limited to: Facebook, Google Analytics, Firebase, Iron Source, Unity Ads, InMobi, and others.
          </Paragraph>
          <Paragraph>
        ...
        <Section>
          ...
          <Paragraph>Except as outlined below, we do not sell or share your personal information with third parties:</Paragraph>
          <List>
            <li><strong>Affiliates & Service Providers:</strong> We may share data with trusted partners and service providers who support our business operations (e.g., hosting, analytics, customer support) under strict confidentiality obligations.</li>
            <li><strong>Legal and Security Reasons:</strong> We may disclose information to comply with legal obligations, protect our rights, or investigate security breaches.</li>
            ...
            <li><strong>Anonymized Data:</strong> We may share aggregated, anonymized data with advertisers or for research purposes.</li>
          </List>
          <Paragraph>
