...
const AboutUs = () => {
  ...
  return (
    <AboutWrapper>
      ...
      <Paragraph>
        At Revolvo Tech, we are passionate about turning ideas into innovative software solutions. Based in Islamabad, Pakistan, we offer comprehensive software development services and create cutting-edge products that empower businesses and individuals around the world.
      </Paragraph>
